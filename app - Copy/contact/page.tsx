          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Available during canteen hours
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-foreground font-medium">canteen@abccollege.edu</p>
                  <p className="text-sm text-muted-foreground mt-1">
                ...
                <CardContent>
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="text-foreground font-medium">7:00 AM - 7:00 PM</span>
                    </div>
                    <div className="flex justify-between">
